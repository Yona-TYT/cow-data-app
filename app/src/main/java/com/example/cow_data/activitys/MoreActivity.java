...
public class MoreActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    private ClearFocusEditText mInput1;
    private ClearFocusEditText mInput2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getExtras() != null) {
            ...
            if(myUser != null) {
                ...
                mInput3.setText(myUser.more3.replaceFirst("@null",""));
                mInput4.setText(myUser.more4.replaceFirst("@null",""));

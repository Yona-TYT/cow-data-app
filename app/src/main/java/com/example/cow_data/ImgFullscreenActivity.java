...
import com.example.cow_data.databinding.ActivityImgFullscreenBinding;
...
//    };
    ...
    private ActivityImgFullscreenBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityImgFullscreenBinding.inflate(getLayoutInflater());
...
//        });
      ...
      //  binding.dummyButton.setOnTouchListener(mDelayHideTouchListener);
        ...
        imageView =  findViewById(R.id.imgFullView);
